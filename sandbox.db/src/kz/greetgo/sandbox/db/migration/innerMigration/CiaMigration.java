...
public class CiaMigration extends Migration {
  ...
  public int migrate() throws Exception {
    ...
    info("Downloaded chunk " + chunkSize + " finished for " + showTime(System.nanoTime(), startedAt));
    ...
    info("Migration chunk " + chunkSize + " finished for " + showTime(System.nanoTime(), startedAt));
...
//            System.out.println(line);
  ...
  private void migrateFromTmp() throws Exception {
    ...
    //language=PostgreSQL
    exec("update TMP_CLIENT set status = 1 from charm f where f.name = charm_name and status = 0");
