...
public class DbWorker {
  ...
  public void prepareConfigFiles() throws IOException {
    prepareConfigDbFile(ConfigFiles.homeDb(), "learn_migration");
    prepareConfigDbFile(ConfigFiles.migrationDb(), "learn_migration_source");
  }
  ...
  public void createCiaDb() throws Exception {
    createDb(ConfigFiles.migrationDb());
  }

  public void dropCiaDb() throws Exception {
    dropDb(ConfigFiles.migrationDb());
  }
