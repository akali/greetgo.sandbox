...
import kz.greetgo.sandbox.db.__prepare__.DropCreateMgrSrcDb;
import kz.greetgo.sandbox.db.__prepare__.DropCreateOperDb;
...
public class MigrationTest {
  ...
  @Test
  public void testFrsCiaIntegration() throws Exception {
    DropCreateOperDb.execute();
    DropCreateMgrSrcDb.execute();
    long start = System.nanoTime();
    LaunchMigration.runMigration();
    System.out.println("/--------------------/");
    System.out.println("Finished migration in " + TimeUtils.showTime(System.nanoTime(), start));
    System.out.println("/--------------------/");
  }
